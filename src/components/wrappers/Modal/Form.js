...
export default function Form({ onSubmit, autoClose = true, hideModal: unsafeHideModal, render, title, renderContextTitle, ...modalProps }) {
	...
	return <FormProvider {...form}>
		<Modal {...{ title, renderContextTitle, hideModal }}>
